// header
{
  ...
  headerNavBtn.addEventListener("click", () => {
    headerBox1.classList.toggle("hiden");
  });
...
// category
{
  ...
  for (var categoryItem of categoryItems) {
    categoryItem.addEventListener("click", function () {
      document
        .querySelector(".category__item.category__item--active")
        .classList.remove("category__item--active");
...

{
  ...
  var categoryItemClothes = document.querySelector(
    '.category__item[type="clothes"]'
  );
  var categoryItemWinter = document.querySelector(
    '.category__item[type="winter"]'
  );
  var categoryItemother = document.querySelector(
    '.category__item[type="other"]'
  );

  var itemAlls = document.querySelectorAll(".product__item");
  var itemClothess = document.querySelectorAll(
    '.product__item[rule="clothes"]'
  );
...

{
  ...
  for (var trendingBtn of trendingBtns) {
    trendingBtn.addEventListener("click", function () {
      document
        .querySelector(".product__navbar-sort-btn.btn--active")
